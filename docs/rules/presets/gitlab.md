...
Use `repoPlugin.configs.gitlab` for GitLab-specific repository compliance requirements.

## Provider documentation

- [GitLab project repository docs](https://docs.gitlab.com/user/project/repository/)
