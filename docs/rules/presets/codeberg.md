---
title: Codeberg preset
---

# 🗻 Codeberg

Use `repoPlugin.configs.codeberg` for Codeberg/Forgejo repository compliance requirements.

## Provider documentation

- [Codeberg getting started](https://docs.codeberg.org/getting-started/what-is-codeberg/)
- [Codeberg pull requests and Git flow](https://docs.codeberg.org/collaborating/pull-requests-and-git-flow/)
- [Forgejo user guide](https://forgejo.org/docs/latest/user/)
- [Forgejo Actions user docs](https://forgejo.org/docs/latest/user/actions/)
