...
- GitHub Security Advisory draft: <https://github.com/Nick2bad4u/eslint-plugin-repo/security/advisories/new>
...
- Keep `eslint-plugin-repo`, ESLint, TypeScript, and dependencies updated.
