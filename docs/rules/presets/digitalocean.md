---
title: DigitalOcean preset
---

# 🌊 DigitalOcean

Use `repoPlugin.configs.digitalOcean` for DigitalOcean App Platform repository compliance requirements.

## Provider documentation

- [DigitalOcean App Platform app spec reference](https://docs.digitalocean.com/products/app-platform/reference/app-spec/)
- [DigitalOcean App Platform how-to guides](https://docs.digitalocean.com/products/app-platform/how-to/)
