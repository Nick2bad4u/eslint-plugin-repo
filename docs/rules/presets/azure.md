...
Use `repoPlugin.configs.azure` for Azure Pipelines repository compliance requirements.

## Provider documentation

- [Azure Pipelines overview](https://learn.microsoft.com/azure/devops/pipelines/?view=azure-devops)
