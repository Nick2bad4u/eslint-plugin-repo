...
Use `repoPlugin.configs.googleCloud` for Google Cloud Build repository compliance requirements.

## Provider documentation

- [Google Cloud Build config file schema](https://cloud.google.com/build/docs/build-config-file-schema)
- [Build Docker images with Cloud Build](https://cloud.google.com/build/docs/build-push-docker-image)
