...
Thanks for using `eslint-plugin-repo-compliance`.
...
2. Search existing issues:
   - <https://github.com/Nick2bad4u/eslint-plugin-repo-compliance/issues>
3. Open a new issue if needed:
   - <https://github.com/Nick2bad4u/eslint-plugin-repo-compliance/issues/new>
...
- TypeScript version
- ESLint version
- `eslint-plugin-repo-compliance` version
