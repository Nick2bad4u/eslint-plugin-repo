---
title: Bitbucket preset
---

# 🪣 Bitbucket

Use `repoPlugin.configs.bitbucket` for Bitbucket repository compliance requirements.

## Provider documentation

- [Bitbucket Cloud getting started](https://support.atlassian.com/bitbucket-cloud/docs/get-started-with-bitbucket-cloud/)
