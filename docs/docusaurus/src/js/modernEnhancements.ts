...
declare global {
    interface Window {
        __repoModernEnhancementsCleanup?: CleanupFunction;
        initializeAdvancedFeatures?: typeof initializeAdvancedFeatures;
        initializeEnhancements?: typeof initializeEnhancements;
    }
}
 ...
 * @param link - Candidate sidebar link.
 *
 * @returns `true` when link is in known numbered rules lists.
 */
function isNumberedRuleSidebarLink(link: HTMLAnchorElement): boolean {
    return (
        ...
        link.closest(".sb-rule-item") !== null
    );
}
...
if (typeof window !== "undefined" && typeof document !== "undefined") {
    window.__repoModernEnhancementsCleanup?.();
    window.__repoModernEnhancementsCleanup = initializeEnhancements();
